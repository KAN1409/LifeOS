...
public class ReconciliationEngineTest {
    @Test public void mergesScreenAndNotificationCopies(){
        long at=100000L;
        MessageObservation s=new MessageObservation(MessageObservation.Direction.UNKNOWN,"  Hello   there ",0,0,100,100,0.74,at);
    ...
    @Test public void knownOppositeDirectionsDoNotMerge(){
        long at=200000L;
        MessageObservation s=new MessageObservation(MessageObservation.Direction.OUT,"same",0,0,100,100,0.80,at);
    ...
    @Test public void differentTextsStaySeparate(){
        long at=300000L;
        MessageObservation s=new MessageObservation(MessageObservation.Direction.IN,"alpha",0,0,100,100,0.80,at);
