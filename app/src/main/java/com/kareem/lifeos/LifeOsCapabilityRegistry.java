...
final class LifeOsCapabilityRegistry {
    ...
    private static String kind(String id){if("people".equals(id))return "People";if("conversations".equals(id))return "Conversation";if("events".equals(id))return "Event";if("commitments".equals(id))return "Commitment";return "Object";}
    private static String countLabel(String id,int count){if("people".equals(id))return count==1?"person":"people";if("conversations".equals(id))return count==1?"conversation":"conversations";if("events".equals(id))return count==1?"event":"events";if("commitments".equals(id))return count==1?"commitment":"commitments";return count==1?"item":"items";}
}
