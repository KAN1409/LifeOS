...
final class LifeOsCapabilityRegistry {
    ...
    private static String kind(String id){if("people".equals(id))return "People";if("conversations".equals(id))return "Conversation";if("decisions".equals(id))return "Decision";if("files".equals(id))return "File";if("places".equals(id))return "Place";if("projects".equals(id))return "Project";if("events".equals(id))return "Event";if("commitments".equals(id))return "Commitment";return "Object";}
    private static String countLabel(String id,int count){if("people".equals(id))return count==1?"person":"people";if("conversations".equals(id))return count==1?"conversation":"conversations";if("decisions".equals(id))return count==1?"decision":"decisions";if("files".equals(id))return count==1?"file":"files";if("places".equals(id))return count==1?"place":"places";if("projects".equals(id))return count==1?"project":"projects";if("events".equals(id))return count==1?"event":"events";if("commitments".equals(id))return count==1?"commitment":"commitments";return count==1?"item":"items";}
}
