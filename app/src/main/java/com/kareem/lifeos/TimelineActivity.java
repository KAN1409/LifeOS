...
public final class TimelineActivity extends Activity {
    ...
    private void timelineRow(LifeDb.Event e){
        ...
        TextView time=LifeOsUi.text(this,new SimpleDateFormat("HH:mm",Locale.getDefault()).format(new Date(e.at)),10.1f,LifeOsUi.MUTED);time.setGravity(Gravity.RIGHT|Gravity.CENTER_VERTICAL);row.addView(time,new LinearLayout.LayoutParams(LifeOsUi.dp(this,49),LifeOsUi.dp(this,rowH)));
        ...
        View icon=LifeOsUi.appIcon(this,e.app,38);LinearLayout.LayoutParams ip=new LinearLayout.LayoutParams(LifeOsUi.dp(this,38),LifeOsUi.dp(this,38));ip.setMargins(0,0,LifeOsUi.dp(this,10),0);row.addView(icon,ip);
        LinearLayout txt=new LinearLayout(this);txt.setOrientation(LinearLayout.VERTICAL);txt.setGravity(Gravity.CENTER_VERTICAL);TextView title=LifeOsUi.text(this,PresentationSemantics.title(this,e),12.6f,LifeOsUi.TEXT);LifeOsUi.weight(title,700);title.setMaxLines(1);txt.addView(title);String summary=PresentationSemantics.summary(this,e);if(summary!=null&&!summary.trim().isEmpty()){TextView body=LifeOsUi.text(this,summary,10.7f,LifeOsUi.MUTED);body.setPadding(0,LifeOsUi.dp(this,3),0,0);body.setMaxLines(1);txt.addView(body);}row.addView(txt,new LinearLayout.LayoutParams(0,LifeOsUi.dp(this,rowH),1));View chev=LifeOsUi.icon(this,LifeOsIconView.CHEVRON,LifeOsUi.TERTIARY,12);LinearLayout.LayoutParams cp=new LinearLayout.LayoutParams(LifeOsUi.dp(this,12),LifeOsUi.dp(this,20));cp.leftMargin=LifeOsUi.dp(this,5);row.addView(chev,cp);row.setOnClickListener(v->startActivity(new Intent(this,EvidenceDetailActivity.class).putExtra("event_id",e.id)));content.addView(row);
    }
