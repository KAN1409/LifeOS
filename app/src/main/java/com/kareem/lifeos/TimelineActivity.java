...
public final class TimelineActivity extends Activity {
    ...
    private void render(){
        ...
        LinearLayout head=new LinearLayout(this);head.setGravity(Gravity.CENTER_VERTICAL);head.setPadding(LifeOsUi.dp(this,16),LifeOsUi.dp(this,8),LifeOsUi.dp(this,9),LifeOsUi.dp(this,5));TextView title=LifeOsUi.text(this,"Timeline",21.2f,LifeOsUi.TEXT);LifeOsUi.weight(title,700);head.addView(title,new LinearLayout.LayoutParams(0,-2,1));View search=LifeOsUi.iconTouch(this,LifeOsIconView.SEARCH,LifeOsUi.TEXT,22,42);search.setContentDescription("Search");search.setOnClickListener(v->LifeOsUi.go(this,SearchActivity.class));head.addView(search,new LinearLayout.LayoutParams(LifeOsUi.dp(this,42),LifeOsUi.dp(this,42)));View filters=LifeOsUi.iconTouch(this,LifeOsIconView.FILTER,LifeOsUi.TEXT,22,42);filters.setContentDescription("Timeline filters");head.addView(filters,new LinearLayout.LayoutParams(LifeOsUi.dp(this,42),LifeOsUi.dp(this,42)));root.addView(head);
    ...
    private void show(){
        ...
        if(shown==0){TextView none=LifeOsUi.text(this,"No meaningful activity in this filter yet.",11.5f,LifeOsUi.MUTED);LifeOsUi.weight(none,500);none.setPadding(0,LifeOsUi.dp(this,15),0,0);content.addView(none);}
    }
    private void timelineRow(LifeDb.Event e){
        final int rowH=64;
        LinearLayout row=new LinearLayout(this);row.setGravity(Gravity.CENTER_VERTICAL);
        TextView time=LifeOsUi.text(this,new SimpleDateFormat("HH:mm",Locale.getDefault()).format(new Date(e.at)),10.1f,LifeOsUi.MUTED);LifeOsUi.weight(time,500);time.setGravity(Gravity.RIGHT|Gravity.CENTER_VERTICAL);row.addView(time,new LinearLayout.LayoutParams(LifeOsUi.dp(this,49),LifeOsUi.dp(this,rowH)));
