...
final class FunctionalCapabilityRegistry {
    ...
    private static String singular(String id){if("conversations".equals(id))return "conversation";if("commitments".equals(id))return "commitment";if("decisions".equals(id))return "decision";if("files".equals(id))return "file";if("projects".equals(id))return "project";if("places".equals(id))return "place";if("people".equals(id))return "person";if("events".equals(id))return "event";return "item";}
    private static String plural(String id){if("conversations".equals(id))return "conversations";if("commitments".equals(id))return "commitments";if("decisions".equals(id))return "decisions";if("files".equals(id))return "files";if("projects".equals(id))return "projects";if("places".equals(id))return "places";if("people".equals(id))return "people";if("events".equals(id))return "events";return "items";}
