...
final class FunctionalCapabilityRegistry {
    ...
    private static String singular(String id){if("conversations".equals(id))return "conversation";if("commitments".equals(id))return "commitment";if("people".equals(id))return "person";if("events".equals(id))return "event";return "item";}
    private static String plural(String id){if("conversations".equals(id))return "conversations";if("commitments".equals(id))return "commitments";if("people".equals(id))return "people";if("events".equals(id))return "events";return "items";}
