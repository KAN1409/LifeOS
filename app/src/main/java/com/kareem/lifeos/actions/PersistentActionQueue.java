...
/** Persistent integration boundary for grounded action proposals and explicit approvals. */
public final class PersistentActionQueue {
    ...
    public static final class Item{public final ActionProposal proposal;public final ActionApproval approval;public final String state;Item(ActionProposal p,ActionApproval a,String s){proposal=p;approval=a;state=s;}}
}
