...
/** Thin transport adapter over the upstream getzep/graphiti FastAPI service. */
public final class GraphitiGateway {
    ...
    public List<Fact> search(String query,int maxFacts) throws Exception{
    ...
    public static final class Fact{public final String uuid,name,fact,validAt,invalidAt,createdAt;public Fact(String uuid,String name,String fact,String validAt,String invalidAt,String createdAt){this.uuid=uuid;this.name=name;this.fact=fact;this.validAt=validAt;this.invalidAt=invalidAt;this.createdAt=createdAt;}}
}
