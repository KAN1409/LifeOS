...
final class PlaceRepository {
    ...
    static Availability availability(Context c){return hasLocationPermission(c)?Availability.OPERATIONAL:Availability.SETUP_REQUIRED;}
